<?php
/**
 * class Shared_Model_Data_AccountTotalingGroupCategory
 * 会計採算コードカテゴリ
 * @package Shared
 * @subpackage Shared_Model_Data
 */
class Shared_Model_Data_AccountTotalingGroupCategory extends Shared_Model_Data_DbAbstract
{
    protected $_tableName = 'frs_account_totaling_group_category';
    ...
    protected $_fields = array(
		...
		'category_name',                       // カテゴリ名
		'layout_version_id',                   // レイアウトバージョンID
     ...
     * @return array
     */
    public function getNextVersion($managementGroupId, $id)
    {
    	$data = $this->getById($managementGroupId, $id);
    	
    	if (!empty($data)) {
    		return (int)$data['layout_version_id'] + 1;
    	}
    	return 1;
    }
