<?php
/**
 * class Shared_Model_Data_ConnectionProgress
 * 実績
 * @package Shared
 * @subpackage Shared_Model_Data
 */
class Shared_Model_Data_ConnectionProgress extends Shared_Model_Data_DbAbstract
{

    protected $_tableName = 'frs_connection_progress';
