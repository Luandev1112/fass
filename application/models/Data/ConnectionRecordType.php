<?php
/**
 * class Shared_Model_Data_ConnectionRecordType
 * 議事録種別
 * @package Shared
 * @subpackage Shared_Model_Data
 */
class Shared_Model_Data_ConnectionRecordType extends Shared_Model_Data_DbAbstract
{

    protected $_tableName = 'frs_connection_record_type';
     ...
     * @return boolean
     */
    public function getActiveList($managementGroupId)
    {
    	$selectObj = $this->select();
    	$selectObj->where('management_group_id = ?', $managementGroupId);
