<?php
/**
 * class Shared_Model_Data_ItemPackageShippingpack
 * 商品パッケージ梱包資材
 * @package Shared
 * @subpackage Shared_Model_Data
 */
class Shared_Model_Data_ItemPackageShippingpack extends Shared_Model_Data_DbAbstract
{

    protected $_tableName = 'frs_item_package_shippingpack';
    ...
    protected $_fields = array(
		...
		'shippingpack_item_id',        // 付属品アイテムID
		'shippingpack_item_amount',    // 付属品数量
    ...
    /**
     * product_codeに紐づく標準梱包資材リスト
     * @param int $itemPackageId
     * @return boolean
     */
    public function getShippingpackItemsByPackageId($itemPackageId)
    {
    	$selectObj = $this->select();
    	
    	$selectObj->joinLeft('frs_warehouse_item', 'frs_item_package_shippingpack.shippingpack_item_id = frs_warehouse_item.id', array('target_type', 'shelf_no', 'image_key'));
    	...
    	/*
    	$selectObj->joinLeft('frs_item', 'frs_item_package_shippingpack.shippingpack_item_id = frs_item.id', array(
    	...
    	*/
    	...
    	$selectObj->where('frs_item_package_shippingpack.status = ?', Shared_Model_Code::ITEM_CODE_BUNDLE_STATUS_ACTIVE);
