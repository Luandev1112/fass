<?php
/**
 * class Shared_Model_Data_SupplyFixtureTag
 * 調達管理 備品資材 タグ
 * @package Shared
 * @subpackage Shared_Model_Data
 */
class Shared_Model_Data_SupplyFixtureTag extends Shared_Model_Data_DbAbstract
{
    protected $_tableName = 'frs_supply_fixture_tag';
