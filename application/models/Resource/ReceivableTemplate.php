<?php
/**
 * class Shared_Model_Resource_ReceivableTemplate
 *
 * 毎月入金管理 参考資料ファイルアップロード
 *
 * @package Shared
 * @subpackage Shared_Model_Resource
 */
class Shared_Model_Resource_ReceivableTemplate extends Shared_Model_Resource_Abstract
{
...
//-------------------------------------------------------------------------------------
    ...
    public static function getResourceDirectoryPath($templateId, $id)
    {
        ...
        return self::_getResourcePath('receivable_template' . DIRECTORY_SEPARATOR . $base . DIRECTORY_SEPARATOR . $templateId . DIRECTORY_SEPARATOR . $id);
    }
    ...
    public static function getResourceObjectPath($templateId, $id, $fileName)
    {
        ...
        return self::_getResourcePath('receivable_template' . DIRECTORY_SEPARATOR . $base . DIRECTORY_SEPARATOR . $templateId . DIRECTORY_SEPARATOR . $id . DIRECTORY_SEPARATOR . $fileName);
    }
    ...
    public static function getResourceUrl($templateId, $id, $fileName)
    {
        ...
        $base = ceil((int)$templateId / 1000) * 1000;   
        return '/rsrc/receivable-template/' . $templateId . '/' . $id . '/' . urlencode($fileName);;
    }
