...
class ManagementController extends Front_Model_Controller
{
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/progress-index                                 |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 営業進捗                                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/progress-main                                  |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 営業進捗                                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/progress-add                                   |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 営業進捗 - 新規登録                                        |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/list-history                                   |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 更新履歴                                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/list-select                                    |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/list-progress                                  |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 営業進捗                                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/list-record                                    |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 議事録一覧                                                 |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/list-contract                                  |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 契約書一覧                                                 |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/list-application                               |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 決議申請                                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/add-post                                       |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 取引先新規登録(Ajax)                                       |
    +----------------------------------------------------------------------------*/
		...
		if ($request->isPost()) {
			...
			if ($validationResult == false) {
	            ...
	            try {
	                ...
	                $connectionTable->getAdapter()->query("UNLOCK TABLES")->execute();
	                throw new Zend_Exception('/management/add-post transaction faied: ' . $e);
    ...
    {
        $this->_helper->layout->setLayout('back_menu');
        $this->view->backUrl = '/management/list';
        
		$request    = $this->getRequest();
    }
    
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/import-csv                                     |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 取引先 CSV取込                                             |
    +----------------------------------------------------------------------------*/
...
*/  	
	...
	*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/relational                                     |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 連携情報                                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/bank-list-select                               |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/relational-list                                |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 旧金融機関データ移行                                       |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/bank-add                                       |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 取引先口座 - 新規登録                                      |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/bank-add-post                                  |
    +-----------------------------------------------------------------------------+
		...
		if ($request->isPost()) {
			...
			if ($validationResult == false) {
	            ...
	            try {
	                ...
	                throw new Zend_Exception('/management/bank-add-post transaction failed: ' . $e);
	            }
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/bank-detail                                    |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 取引先口座 - 詳細                                          |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/bank-update                                    |
    +-----------------------------------------------------------------------------+
		...
		if ($request->isPost()) {
			...
			if ($validationResult == false) {
	            ...
	            try {
	                ...
	                $connectionBankTable->getAdapter()->rollBack();
	                throw new Zend_Exception('/management/bank-update transaction failed: ' . $e);
	            }
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/industry-select                                |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 業種選択（ポップアップ）                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-basic                                   |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 基本情報更新(Ajax)                                         |
    +----------------------------------------------------------------------------*/
    ...
    public function deleteAction()
    {
		...
		if ($request->isPost()) {
			...
			try {
                ...
                $connectionTable->getAdapter()->rollBack();
                throw new Zend_Exception('/management/delete transaction failed: ' . $e);
            }
	...
	/*----------------------------------------------------------------------------+
    |  action_URL    * /management/account-confirmed                              |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 破棄(管理権限あり)(Ajax)                                   |
    +----------------------------------------------------------------------------*/
    public function accountConfirmedAction()
    {
		...
		if ($request->isPost()) {
			...
			try {
                ...
                $connectionTable->getAdapter()->rollBack();
                throw new Zend_Exception('/management/account-confirmed transaction failed: ' . $e);
            }
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-base                                    |
    +-----------------------------------------------------------------------------+
    ...
    */
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-credit                                  |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 信用情報更新(Ajax)                                         |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-financial-closing                       |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 決算情報更新(Ajax)                                         |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/base-select                                    |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 拠点 ポップアップ選択用                                    |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/base-edit                                      |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 拠点 新規登録/編集                                         |
    +----------------------------------------------------------------------------*/
    ...
    public function updateBaseAction()
    {
		...
		if ($request->isPost()) {
			$config = $this->getActionConfig();
			if (empty($config)) {
				throw new Zend_Exception('/management/update-base failed to load config');
			}
			$validate = new Nutex_Parameters_Validate($config);
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/department                                     |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 部門・担当者                                               |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/staff-select                                   |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/department-edit                                |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-department                              |
    +-----------------------------------------------------------------------------+
    ...
    public function updateDepartmentAction()
    {
		...
		if ($request->isPost()) {
			$config = $this->getActionConfig();
			if (empty($config)) {
				throw new Zend_Exception('/management/update-department failed to load config');
			}
			$validate = new Nutex_Parameters_Validate($config);
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/department-staff-edit                          |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-department-staff                        |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-staff-list                              |
    +-----------------------------------------------------------------------------+
		...
		if ($request->isPost()) {
			...
			if ($validationResult == false) {
	            ...
	            try {
	                ...
	                throw new Zend_Exception('/management/update-staff-list transaction failed: ' . $e);   
	            }
			}
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/sales-info                                     |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 販売・役務提供情報                                         |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/provide-info                                   |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-provide-info                            |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-sales-payment-coonditions               |
    +-----------------------------------------------------------------------------+
    ...
    */
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/investment-info                                |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 投融資情報                                                 |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-investment-info                         |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 投融資情報更新(Ajax)                                       |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/update-investment-account                      |
    +-----------------------------------------------------------------------------+
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/progress                                       |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 営業進捗                                                   |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/transaction                                    |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 取引実績（発注受注）                                       |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/estimate                                       |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 見積提出実績                                               |
    +----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------+
    |  action_URL    * /management/contract                                       |
    +-----------------------------------------------------------------------------+
    |  アクション名  * 契約書                                                     |
    +----------------------------------------------------------------------------*/
