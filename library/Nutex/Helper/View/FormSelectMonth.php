<?php
/**
 * class Nutex_Helper_View_FormSelectMonth
 *
 * @package Nutex
 * @subpackage Nutex_Helper_View
 */
class Nutex_Helper_View_FormSelectMonth extends Nutex_Helper_View_Abstract
{
    /**
     * 月のプルダウン作成
     * ○○月のプルダウンを作成する
     ...
     */
    public function formSelectMonth($name, $value=null, $attribs=null, $prefix=null, $noSelectString=null, $isAddZeroKeyValue=FALSE) {
        $options = array();
        for ($i=1; $i<=12; $i++) {
