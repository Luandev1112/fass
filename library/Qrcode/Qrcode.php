...
/********************************************************************
* QRcode class library Custmized For Nutex-Zend Environment
*
* @see     http://www.swetake.com/
* @Created 2010/02/05 MIYANO MASATO
*
*********************************************************************/
define ( "QRCODE_DATA_PATH", APPLICATION_PATH . DIRECTORY_SEPARATOR .
                             '..' . DIRECTORY_SEPARATOR .
...
/* ---- read version ECC data file */
    ...
    $filename=QRCODE_DATA_PATH.DIRECTORY_SEPARATOR."qrv".$this->qrcode_version."_".$ec.".dat";
    ...
    $filename = QRCODE_DATA_PATH.DIRECTORY_SEPARATOR."rsc".$rs_ecc_codewords.".dat";
...
/* -- read frame data  -- */
    ...
    $filename = QRCODE_DATA_PATH.DIRECTORY_SEPARATOR."qrvfr".$this->qrcode_version.".dat";
    $fp0 = fopen ($filename, "rb");
