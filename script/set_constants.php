...
define('APPLICATION_DOMAIN', 'localhost');

define('GMO_AOZORA_API_DOMAIN', 'https://stg-api.gmo-aozora.com');

define('GS_DOMAIN', 'dev.goosa.net');
define('GCS_DOMAIN', 'dev.goosca.jp');
